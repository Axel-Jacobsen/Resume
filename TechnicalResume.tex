...
\begin{adjustwidth}{0.55cm}{1.25cm}
	...
	\custombold{Coursework includes} Object-Oriented Programming; Signals and Systems; Applied Quantum Mechanics; Mechanical Design; Digital Systems and Microcomputers; Linear Algebra; Honours Multivariable and Vector Calculus; Complex Analysis
\end{adjustwidth}
\vspace{8pt}
...
\begin{adjustwidth}{0.55cm}{1.25cm}
	...
	\custombold{Coursework includes} Operating Systems, Deep Learning, Robotics, Computationally Hard Problems
\end{adjustwidth}
