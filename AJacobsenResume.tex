...
\begin{tightemize}
    \item Rewrote OT-2 code base with a focus on speeding up epithelial cell growth protocols - reduced code base size by \char`\~ 75\%, doubled speed of certain frequent operations
